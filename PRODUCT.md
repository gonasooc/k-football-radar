...
- Generic AI dashboard surfaces with oversized metrics, decorative gradients, dark hero panels, and repeated card grids.
...
Target WCAG AA contrast for text and controls. Avoid relying on color alone for news vs official distinctions. Keep motion subtle and state-driven. Korean text must remain readable at dense dashboard sizes, with no viewport-scaled typography that causes mobile overflow.
